...
\end{lemma}
\begin{proof}[Sketch]
    By induction on the structure of the derivation of \( \scong{P}{Q} \), with an inner induction of the structure of a process context and an appeal to Lemma~\ref{se-lemma-harmony-facta}.
\end{proof}
