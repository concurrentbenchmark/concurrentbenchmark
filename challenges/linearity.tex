...
\end{lemma}
\begin{proof}
  By induction on the last applied rule of the proof of
...
\begin{proof}
  ...
  $y_1$ such that $P_1\equiv\Pout{x_1}{v}{P_1'}$ (the opposite case
  proceeds similarly). We need to show that
  $P_2\equiv\Pin{y_1}{v}{P_2'}$. This can be easily done by
  contradiction. In fact, if $P_2\equiv\Pout{x}{v}{P_2'}$ then the
