...
To simplify the definition of the reduction relation, we will  factor out a \emph{structural congruence} relation on processes, namely  ithe smallest congruence relation that satisfies the following axioms:
\begin{mathpar}
