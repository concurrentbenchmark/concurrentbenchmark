...
\begin{proof}
  ...
  \begin{description}
    \item[$P = \Pend$] By inversion on the typing we have $\tend{\Delta}$. Apply \TirName{T-Inact}.
  ...
  \begin{description}
    ...
    \item[$P = \Ppar{P_0}{P_1}$] By inversion on the typing we get derivations for $P_0$ and $P_1$. Apply IH on both.
     ...
     \item[$P = \Pout{x}{v}{P}$] Invert typing. We have $\typev{(\Gamma,l)}{\hastype{v}{\Tbase}}$.
       We must show $\typev{\Gamma}{\hastype{v}{\Tbase}}$ to build the conclusion with IH and \TirName{T-Out}. Go by cases on the structure of $\typev{(\Gamma,l)}{\hastype{v}{\Tbase}}$.
...
\begin{proof}
  ...
  assumptions $\Cadd{\hastype{x}{\Tout{U}}}{\hastype{y}{\Tin{\dual{U}}}}$.  Building the only tree for the
