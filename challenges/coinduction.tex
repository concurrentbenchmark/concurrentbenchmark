...
We must therefore allow ourselves to observe more than just internal transitions, and here choose to define the observables of a process as the names it can use for sending and receiving.
