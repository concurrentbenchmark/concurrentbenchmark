...
% Multiparty session types, and choreographies.

% different notions of bisimilarity (barbed, or weak, etc.), trace equivalence.

% Exercising different features of proof assistants like: code
% extraction and/or code automation.

% Interaction between formalised proofs and model checkers.
