...
\and Martin Vassor \inst{4}\orcidID{0000-0002-2057-0495}
\and Nobuko Yoshida \inst{4}\orcidID{0000-0002-3925-8557}
\and Daniel Zackon \inst{8}\orcidID{0000-0000-0000-0000}
}

\institute{
     IT University of Copenhagen \email{maca@itu.dk}
\and University of Kent \email{D.Castro-Perez@kent.ac.uk}
\and Royal Holloway, University of London \email{Francisco.FerreiraRuiz@rhul.ac.uk}
\and University of Oxford \email{lorenzo.gheri@cs.ox.ac.uk}, \email{martin.vassor@cs.ox.ac.uk}, \email{nobuko.yoshida@cs.ox.ac.uk}
\and Technical University of Denmark \email{fkjac@dtu.dk}, \email{alcsc@dtu.dk}
\and Università degli Studi di Milano \email{momigliano@di.unimi.it}
\and Università di Camerino \email{luca.padovani@unicam.it}
\and McGill University \email{daniel.zackon@mail.mcgill.ca}
}
