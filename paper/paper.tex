...
\[
\begin{array}{rcl}
  P,Q & :=& \Pend \quad\mid\quad \PBpar{P}{Q} \quad\mid\quad \Pout{x}{y}{P} \quad\mid\quad \Pin{x}{y}{P} \quad\mid\quad \Pres{x}{P}
\end{array}
\]
...
\[
\begin{array}{rcl}
  \alpha & :=& \Aoutf{x}{y} \quad\mid\quad \Ain{x}{y} \quad\mid\quad \Aoutb{x}{y} \quad\mid\quad \Atau
\end{array}
\]
...
For the proof of the challenge theorem, we will introduce the notion of a \emph{normalized derivation} of a reduction \( \reduces{P}{Q} \), which is of the following form.
...
\subsection{Challenge: Coinduction and infinite }
