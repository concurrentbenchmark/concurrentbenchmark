...
Our challenges also require reasoning about logical relations which goes above the reasoning involved in POPLMark Reloaded.\fxwarning{does it? as in do we define a type indexed
  relation and then use that to prove things?}
...
De\ Bruijn indices do not have the concept of free variables. For this
kind of system the means to encode the operational semantics are not
obvious.
