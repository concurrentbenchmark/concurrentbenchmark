...
We have identified three key aspects which cause issues when mechanising concurrency theory: linearity in behavioural type systems, scope extrusion in name passing systems and infinite behaviour modelled coinductively.
