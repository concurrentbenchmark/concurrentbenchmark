...
Papers in concurrency theory do often include mechanized proofs (e.g.~\cite{DBLP:conf/tacas/CastroFY20, DBLP:conf/pldi/Castro-Perez0GY21,lmcs:9985, DBLP:journals/jar/CruzFilipeMP23, Tirore:2023}), and others also directly discuss formalisation techniques (e.g.~\cite{DBLP:conf/tphol/Gay01, DBLP:journals/jar/BengtsonPW16, DBLP:conf/ppdp/Thiemann19, DBLP:conf/forte/ZalakainD21}). However, our experience is that choosing techniques and tools remains a challenge with few guidelines.
