...
\begin{mathpar}
  ...
  \inferrule[T-Out]{\types{\Gamma;\Delta_1}{\hastype{x}{\Tout{T}}} \\
    \types{\Gamma;\cdot}{\hastype{v}{\Tbase}} \\ \types{\Gamma; \Cupdate{\Delta_2}{\hastype{x}{T}}}{P}}{\types{\Gamma; \Csplit{\Delta_1}{{\Delta_2}}}{\Pout{x}{v}{P}}}
  \and
  \inferrule[T-In]{\types{\Gamma;\Delta_1}{\hastype{x}{\Tin{U}}}
    \\ \types{\Gamma,\hastype{l}{\Tbase}; \Delta_2,\hastype{x}{U}}{P}}
      {\types{\Gamma; \Csplit{\Delta_1}{\Delta_2}}{\Pin{x}{l}{P}}}
\end{mathpar}
