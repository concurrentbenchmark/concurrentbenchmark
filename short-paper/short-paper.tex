...
Coq features guarded recursion and refined fixed point approaches via libraries such as the parameterised coinduction~\cite{Hur2013}, coinduction up-to~\cite{Pous16}
and interaction trees~\cite{Xia2019} .
