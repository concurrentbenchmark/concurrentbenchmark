...
In this section, we outline our considerations in designing the benchmark challenges.
We will begin with our design goals, then describe design considerations for each challenge problem, and finally suggest some evaluation criteria for solutions.

Similarly to the authors of the POPLMark challenges, we seek to
answer several questions about mechanising the meta-theory of process calculi:
