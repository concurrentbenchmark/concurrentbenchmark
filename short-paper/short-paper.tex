...
make a good case for formalization.}\luca{as a follow up to the previous
comment, if there is agreement that recursive types impact the coinduction
challenge then the relevance of Table 1 may be questionable because almost every
extension impacts almost every challenge. In case of need we may consider
removing the table in favor of more prose.}
