...
We begin with some general remarks, then describe the individual design considerations for each challenge, and the criteria for evaluating solutions thereof.
...
formulated our challenges to explore the three aspects
...
Aligned with design goal~\ref{item:goal-reusability}, our challenges are rooted in the fundamental meta-theory of process calculi, without necessitating the creation of novel theory.
