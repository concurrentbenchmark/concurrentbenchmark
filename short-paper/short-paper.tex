...
\emph{linear predicate} defined on the process structure. These checks would
serve as additional conditions within the typing rule,
\eg~\cite{BP23}. Whatever the choice,
...
\section{Future Work and Conclusion}\label{sec:going-beyond}
