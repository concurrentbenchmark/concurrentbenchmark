...
polarities. % , and generally
% addressed by Vasconcelos and Yoshida~\cite{Yoshida2007}.
% it took nine years before the incorrect proof of type safety in the
% seminal paper by Honda et al.~\cite{Honda1998} was rectified in
% Yoshida and Vasconcelos’s subsequent
% work\cite{Yoshida2007}.\todo{Marco: rewrite this to be correct}
...
% \todo{Rephrase this sentence to be more clear on the references}
% =======
...
% Vasconcelos’s subsequent work\cite{Yoshida2007}.\todo{Marco: rewrite this to be correct}
...
% >>>>>>> 1280d8dcd1c1a2b294f6f2d2cdf08e9808a9518c
...
Another approach is shallow embeddings~\cite{Castro-Perez2021}, which avoids the need to explicitly represent names.\todo{Merge the previous sentence into the HOAS section?}
