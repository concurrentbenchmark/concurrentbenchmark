...
evaluating mechanisation techniques, it catalyzed a significant
...
Our benchmark problems (detailed in \cref{app:challenges}) center around three key aspects that frequently pose challenges when mechanising concurrency theory: \emph{linearity}, \emph{scope extrusion}, and \emph{coinductive reasoning}.
...
discussed further in \Cref{sec:going-beyond}.
