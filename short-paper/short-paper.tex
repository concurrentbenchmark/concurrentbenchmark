...
\begin{abstract}
  ...
  message-passing concurrency using process calculi.\luca{I like Daniel's proposal below} \dz{Maybe something like, ``\ldots that typically arise when mechanising formal models of concurrent and distributed programming languages, such as process calculi.''?} Our benchmark problems
