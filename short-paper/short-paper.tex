...
The introduction of strong barbed bisimulation is one of the first steps when studying the observable behaviour of process calculi, both in classical textbooks (e.g., \cite{picalcbook}) and in existing mechanisations.
